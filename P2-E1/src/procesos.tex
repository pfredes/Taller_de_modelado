...
\subsection{Descripción de modelos de procesos nivel 2} 

\begin{itemize}

\item \textbf{Producción de Hallulla:} Una de los 3 procesos más importantes de la panadería. Posee como entrada la solicitud de pedido del Proceso de Distribución.
...
Figura 7: Proceso de producción de pan Hallulla nivel 2.
\end{center}
...
Figura 8: Proceso de producción de pan  Marraquera nivel 2.
\end{center}


\item \textbf{Ventas:} El principal objetivo de este proceso es atender a la clientela, como punto de partida el cliente llega al local pidiendo el pan o repostería que quiere, se Recibe su pedido, luego se verifica si hay pan o repostería suficiente para atender lo requerido, puede haber o no, en caso de no haber pan o repostería se ve cuanta cantidad se necesitaría aproximadamente y se envía a Producción, en este último pueden hacer más pan o repostería o simplemente notifican que no se puede hacer más pan por motivos varios, en caso de hacer más pan o repostería se envía pan o repostería a la sala de ventas, se hace el vale. Ahora en caso de que haya pan o repostería solamente se procede a hacer el vale. Luego el cliente recibe el vale con el cual procede a pagar finalizando el proceso.\\
Como entrada posee alguna solicitud del cliente y como salida la transacción realizada.
...
Figura 10: Proceso de Distribución nivel 2.
\end{center}
...
Figura 11: Proceso de Abastecimiento de nivel 2.
\end{center}
...
\subsection{Descripción de modelos de procesos nivel 3} 
...
Figura 7: Proceso de producción de pan Hallulla nivel 3.
\end{center}
...
Figura 8: Proceso de producción de pan  Marraquera nivel 3.
\end{center}
...
Figura 9: Proceso de Ventas nivel 3.
\end{center}
...
\begin{center}
\includegraphics[width=15cm]{./imagenes/DistribucionN2.png}\\
Figura 10: Proceso de Distribución nivel 3.
\end{center}
...
Figura 11: Proceso de Abastecimiento de nivel 3.
\end{center}
